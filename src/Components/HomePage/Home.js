                  ...
                  <div className='tab-content' id='myTabContent'>
                    ...
                    >
                      <form className='form-wrap'>
                        ...
                        {/* <!-- <a href="#" className="primary-btn text-uppercase" id="nextBtn"
                    >Next</a --> */}
                      </form>
                    </div>
                    <div
              ...
              <div className='row align-items-center'>
                ...
                <div className='col-lg-6 insurence-right'>
                  ...
                  <p>
                    ...
                    swift and easy process. Have your car picked up in NJ and
                    get your CASH ON THE SPOT! We Pay Top Dollar! Call Us Now!
                  </p>
                  {/*<div className="list-wrap">
              <ul>
                <li>Strategic approach towards redesigning brand.</li>
                <li>
                  logo design strategy ensures a perfectly crafted logo for your
                  business.
                </li>
            ...
            <div className='container'>
              <div className='row align-items-center'>
                <div className='col-lg-6 insurence-left'>
                  ...
                  <h1>Our steps</h1>
                  {/* <!-- <p>
              Will call you and come to you Give you cash on the spot of your
              car.
            </p> --> */}
                  <div className='list-wrap'>
                    <ul>
                ...
                <div className='col-lg-3 col-md-6 col-sm-6'>
                  <div className='single-footer-widget'>
                    ...
                    <p>
                      ...
                      highest dollars. We come to you and buy your car as it is!
                      Sell your car quickly and easily today!
                    </p>
                  </div>
                </div>
                <div className='col-lg-3 col-md-6 col-sm-6'>
